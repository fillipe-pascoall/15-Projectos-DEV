...
var currentHour=document.querySelector(".current-hour");
var hour=document.querySelector(".hour");
var min=document.querySelector(".min");
var currentDate=document.querySelector(".current-date");
currentHour.innerHTML='<span class="hour">'+hh+'</span><span class="min"> '+mt+'</span>min';
currentDate.innerHTML=nw[ww]+", "+dd+" "+nm[mm];
